...
def labeling():
    BFRB = ["Above ear - Pull hair", "Forehead - Pull hairline", "Forehead - Scratch", "Eyebrow - Pull hair", "Eyelash - Pull hair", "Neck - Pinch skin", "Neck - Scratch", "Cheek - Pinch skin"]
    BFRB_int = [i for i in range(len(BFRB))]
    ...
    non_BFRB_int = [i for i in range(len(BFRB), len(BFRB)+len(non_BFRB))]
...
class ModelVariant_LSTMGRU(nn.Module):
    ...
    def __init__(self, num_classes: int):
        ...
        self.attention_pooling = AttentionLayer(1360)

        # 5. Prediction heads
        in_feat = 1360 + 32  # pooled + meta
