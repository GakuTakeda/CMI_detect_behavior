...
from utils import TwoBranchModel, ModelVariant_LSTMGRU, ModelVariant_LSTMGRU_TinyCNN, ModelVariant_Conf, MacroImuModel
...
class LitModel_for_Macro_Imu(L.LightningModule):
    def __init__(self, cfg, num_classes,
                 lr_init=1e-3, weight_decay=1e-4, t0_factor=5, cls_loss_weight=1.0, class_weight=[1,1,1,1,1,1]):
        super().__init__()

        self.model = MacroImuModel()
